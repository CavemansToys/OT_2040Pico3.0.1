/**
 * @file lv_conf.h
 * @brief LVGL Configuration for TFT35/TFT43 on RP2040 (Pico W)
 *
 * Optimized for:
 * - RP2040 Cortex-M0+
...
/* RP2040 has 264KB SRAM - allocate 16KB for LVGL (minimal) */
...
/* Disable assembly optimizations (not available on Cortex-M0+) */
